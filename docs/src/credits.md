# Créditos
Obs: as contribuições relacionadas ao repositório podem ser observadas com mais detalhes na nossa árvore git.

## André Barata ([BarataDragon](https://github.com/BarataDragon))
- Compra de parte dos materiais em loja física.
...
- Organização da lista de materiais.
- Pesquisa e compra de parte dos materiais pelo Mercado Livre.
- Compra de parte dos materiais em loja física.
- Organização da documentação e correções pontuais.
